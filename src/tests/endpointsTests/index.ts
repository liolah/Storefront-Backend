...
export default function () {
  describe('API Endpoints:', () => {
    const token =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwYXNzd29yZF9kaWdlc3QiOiIkMmIkMTAkRWFaSm8yeDU3Snd5emxDajJCU0ZidU5ScVhvYmppZ0MwQjBNMEJNaUpYdVFxTGZvMURIdEsiLCJpYXQiOjE2NDQ5MzI0ODd9.wFrzB-u7NWlLOkAbWcgrma-CuNR0_3dVw_BISErtf0E';
